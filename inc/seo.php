...
function rm_seo_meta_box_add() {
	...
	add_meta_box( 'seo-meta-box', 'SEO fields', 'rm_seo_meta_box_cb', 'event', 'normal', 'high' );
}
...
function rm_seo_title() {
	...
	if( is_singular() && isset($post->ID) ) {
		...
		$title = wp_title('&raquo;', false, 'right') . get_bloginfo('name');
		$description = get_bloginfo('description');
		$keywords = wp_title(',', false, 'right') . get_bloginfo('name');
	}
	echo '
	<title>' . $title . '</title>
